...
namespace BepInEx_DemulShooter_Plugin
{
    class mLanguageLocalizer
    {
        ...
        class SwitchLanguage
        {
            ...
            {
                DemulShooter_Plugin.MyLogger.LogMessage("LanguageLocalizer.SwitchLanguage(), i_Code=" + i_Code);
                DemulShooter_Plugin.MyLogger.LogMessage("LanguageLocalizer.SwitchLanguage(), Available Languages :");
                ...
                DemulShooter_Plugin.MyLogger.LogMessage("LanguageLocalizer.SwitchLanguage() : Succesfully sets Language to " + i_Code.ToString());
