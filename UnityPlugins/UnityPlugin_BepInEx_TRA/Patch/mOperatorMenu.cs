...
namespace BepInEx_DemulShooter_Plugin
{
    class mOperatorMenu
    {
        ...
        class ResetData
        {
            ...
            {
                DemulShooter_Plugin.MyLogger.LogMessage("OperatorMenu.ResetData() : Trying to read custom config file: " + BepInEx.Paths.GameRootPath + "TombRaider_Operator.conf");
                DemulShooter_Plugin.PrintStackTrace();
           //     try
           //     {
           //         String[] lines = System.IO.File.ReadAllLines(BepInEx.Paths.GameRootPath + @"\TombRaider_Operator.conf");
           ...
           //             }
           //         }
           //         DemulShooter_Plugin.MyLogger.LogMessage("mOperatorMenu.ResetData() : Succes !");
           //     }
           //     catch (Exception Ex)
           //     {
           //         DemulShooter_Plugin.MyLogger.LogMessage("mOperatorMenu.ResetData() : Can't read config data, using custom default values.");
           //         DemulShooter_Plugin.MyLogger.LogMessage("mOperatorMenu.ResetData() : " + Ex.Message.ToString());
