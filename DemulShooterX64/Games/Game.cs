...
namespace DemulShooterX64
{
    public class Game
    {
        ...
        protected UInt64 _InputsDatabank_Address = 0;
        protected UInt64 _OutputsDatabank_Address = 0;
        ...
        protected virtual void Create_InputsDataBank()
        {
            try
            {
                ...
                Logger.WriteLog("Custom output data will be stored at : 0x" + CaveMemoryInputs.CaveAddress.ToString("X16"));
            }
            catch (Exception Ex)
            {
        ...
        protected virtual void Create_OutputsDataBank()
        {
            try
            {
                ...
                Logger.WriteLog("Custom output data will be stored at : 0x" + CaveMemoryOutputs.CaveAddress.ToString("X16"));
            }
            catch (Exception Ex)
            {
