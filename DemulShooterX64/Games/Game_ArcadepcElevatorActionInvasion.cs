...
{
    class Game_ArcadepcElevatorActionInvasion : Game
    {
        ...
        /// Constructor
        /// </summary>
        public Game_ArcadepcElevatorActionInvasion(String RomName)
            : base(RomName, "ESGame-Win64-Shipping")
        {
            ...
            if (!_DisableInputHack)
            {
                if (nCode >= 0)
                {
                    ...
                    if ((UInt32)wParam == Win32Define.WM_KEYDOWN)
                    {
                        ...
                        else if (s.scanCode == Configurator.GetInstance().DIK_Eai_P2_Credits)
                        {
        ...
        protected override void CreateOutputList()
        {
            ...
            _Outputs.Add(new GameOutput(OutputId.DoorA));
            _Outputs.Add(new GameOutput(OutputId.DoorB));
            _Outputs.Add(new GameOutput(OutputId.ElevatorLedsStatus));
