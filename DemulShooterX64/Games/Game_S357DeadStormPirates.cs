...
{
    public class Game_S357DeadStormPirates : Game
    {
        //MEMORY ADDRESSES
        ...
        private UInt64 _P1_Axis_Address = 0x33434CCC4;
        private UInt64 _P2_Axis_Address = 0x3342F3744;
        private UInt64 _Buttons_Address = 0x301348BBC;

        //Outputs
        private UInt64 _Outputs_Address = 0x301348658;
        private UInt64 _Credits_Address = 0x301348B8B;
        ...
        private void Check_PatchedFiles_Ok()
        {
            ...
            String PPU_CachePath = EmulatorBasePath + @"cache\SCEEXE000\ppu-obiMX8TqMzUsChXLV1Ln5TAJegSZ-EBOOT.BIN";
            ...
            foreach (String File in Directory.GetFiles(PPU_CachePath))
            {
                ...
                if (sFile.StartsWith("v5-kusa-0v5qK7ZgNQz7zP6MmKCY5U-00001G"))
                {
                    try
                    {
            ...
            if (CPU_Type != string.Empty)
            {
                ...
                CompareMd5Hash(PPU_CachePath + @"\v5-kusa-i7aj8qVvJVSC4AVE3TbxET-00001G-" + CPU_Type + ".obj.gz", "6220bb0b28f76847c34dc0988e8c8e82");
                CompareMd5Hash(PPU_CachePath + @"\v5-kusa-RfXcExAKkmrdG4qseqx2b8-00001G-" + CPU_Type + ".obj.gz", "1e3f2024a1d48c11f02412882ed3e702");
            }
            else
            {
        ...
        public override bool GameScale(PlayerSettings PlayerData)
        {
            if (_ProcessHandle != IntPtr.Zero)
            {
                try
                {
                    ...
                    /*if (PlayerData.RIController.Computed_X < 64)
                        PlayerData.RIController.Computed_X = 64;
                    if (PlayerData.RIController.Computed_Y < 64)
                        PlayerData.RIController.Computed_Y = 64;
                    if (PlayerData.RIController.Computed_X > 1216)
                        PlayerData.RIController.Computed_X = 1216;
                    if (PlayerData.RIController.Computed_Y > 592)
                        PlayerData.RIController.Computed_Y = 592;*/
        ...
        public override void SendInput(PlayerSettings PlayerData)
        {
            if (!_DisableInputHack)
            {
                float fX = (float)PlayerData.RIController.Computed_X;
                float fY = (float)PlayerData.RIController.Computed_Y;
        ...
        public override void UpdateOutputValues()
        {
            ...
            byte bRumble = ReadByte((IntPtr)_Outputs_Address);
            int P1_Rumble = bRumble & 0xC0;
            int P2_Rumble = bRumble & 0x30;
