...
namespace DemulShooterX64
{
    public class Game_S357DarkEscape : Game
    {
        ...
        /// Constructor
        /// </summary>
        public Game_S357DarkEscape(String RomName) : base(RomName, "rpcs3-gun")
        {
                ...
                try
                {
                    ...
                    if (processes.Length > 0)
                    {
                        ...
                        if (_TargetProcess_MemoryBaseAddress != IntPtr.Zero)
                        {
                            ...
                            if (FindGameWindow_Contains("DarkEscape")|| FindGameWindow_Contains("RPCS3 via TeknoParrot"))
                            {
        ...
        protected override void CreateOutputList()
        {
            ...
            _Outputs.Add(new GameOutput(OutputId.P1_Fan));
            _Outputs.Add(new GameOutput(OutputId.P2_Fan));
