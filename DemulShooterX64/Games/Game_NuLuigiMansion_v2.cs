...
namespace DemulShooterX64
{
    public class Game_NuLuigiMansion_v2 : Game
    {
        ...
        protected override void CreateOutputList()
        {
            ...
            _Outputs.Add(new GameOutput(OutputId.P1_LmpWindow_R));
            _Outputs.Add(new GameOutput(OutputId.P1_LmpWindow_G));
            _Outputs.Add(new GameOutput(OutputId.P1_LmpWindow_B));
            _Outputs.Add(new GameOutput(OutputId.P2_LmpWindow_R));
            _Outputs.Add(new GameOutput(OutputId.P2_LmpWindow_G));
            _Outputs.Add(new GameOutput(OutputId.P2_LmpWindow_B));
