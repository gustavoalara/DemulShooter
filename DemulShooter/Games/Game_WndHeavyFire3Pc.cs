...
namespace DemulShooter
{
    ...
    class Game_WndHeavyFire3Pc : Game
    {
        ...
        private const String HFA_STEAM_FILENAME = "heavyfire3_final";
        private const String HFA_SKIDROW_FILENAME = "heavyfire3";
        ...
        private UInt32 _Mouse_Buttons_PatchOffset = 0x00116390;
        private UInt32 _NoGun_Patch_Offset = 0x000D7592;
        private NopStruct _Nop_MouseCursorWhenGetFocus = new NopStruct(0x001156E0, 8);
        private NopStruct _Nop_MouseCursorWhenLooseFocus = new NopStruct(0x001157FA, 8);
        private InjectionStruct _PlayersOnOff_InjectionStruct = new InjectionStruct(0x0001E634, 6);
        private InjectionStruct _Mouse_Buttons_InjectionStruct = new InjectionStruct(0x0001E82A, 6);
        private InjectionStruct _Mouse_X_InjectionStruct = new InjectionStruct(0x0001E85F, 7);
        private InjectionStruct _Mouse_Y_InjectionStruct = new InjectionStruct(0x0001E87C, 7);
        private InjectionStruct _Recoil_InjectionStruct = new InjectionStruct(0x00E8045, 5);
        private InjectionStruct _Ammo_InjectionStruct = new InjectionStruct(0x000C5293, 8);
        private InjectionStruct _Damage_InjectionStruct = new InjectionStruct(0x000C1C7E, 7);
        private InjectionStruct _GamePlaying_InjectionStruct = new InjectionStruct(0x00108AE9, 7);
        private InjectionStruct _NoCrosshair_InjectionStruct = new InjectionStruct(0x000AF009, 8);
        private NopStruct _Nop_SteamForceMouseMainController = new NopStruct(0x0001E002, 6);
        ...
        /// Constructor
        /// </summary>
        public Game_WndHeavyFire3Pc(String RomName)
            : base(RomName, "hf4")
        {
            _KnownMd5Prints.Add("Heavy Fire 3 - SKIDROW", "3f49951ae8232817a91ef5503374d6b3");
            _KnownMd5Prints.Add("Heavy Fire 3 - STEAM", "1841e571286acb17a98546a439c08e57");
            _KnownMd5Prints.Add("Heavy Fire 3 - Unknown #1", "4344f54b91e7a8ef20042d5f0b6e04aa");
        ...
        private void SetHack_EnablePlayers_Steam()
        {
            ...
            WriteBytes((UInt32)_TargetProcess_MemoryBaseAddress + _PlayersOnOff_InjectionStruct.InjectionOffset - 0x35, new byte[] { 0xEB, 0x2F });

            //And force the byte to be stored
            //mov [edi], al
            WriteBytes((UInt32)_TargetProcess_MemoryBaseAddress + _PlayersOnOff_InjectionStruct.InjectionOffset + 0x0A, new byte[] { 0x88, 0x07, 0x90, 0x90, 0x90, 0x90 });
            ...
            //mov al,[eax]
            CaveMemory.Write_StrBytes("8A 00");
            //cmp [esi*4+hf4.exe+4234D4],ebp
            CaveMemory.Write_StrBytes("83 3C B5 D4 34 62 00 01");
        ...
        private void SetHack_Mouse_Buttons()
        {
            ...
            //mov [esi+0000009B],al
            CaveMemory.Write_StrBytes("88 86 9B 00 00 00");
            //push ebx
            CaveMemory.Write_StrBytes("53");
            //mov ebx,[esp+04]                          //Player Id
            CaveMemory.Write_StrBytes("8B 5C 24 04");
            ...
            //mov [esi+00000080],al
            CaveMemory.Write_StrBytes("88 86 80 00 00 00");
            //mov [esi+00000086],al
            CaveMemory.Write_StrBytes("88 86 86 00 00 00");
            //add ebx,04
            CaveMemory.Write_StrBytes("83 C3 04");      //Reload byte is +4 after Trigger cave address
            //mov al,[ebx]
            CaveMemory.Write_StrBytes("8A 03");
            //mov [esi+00000083],al
            CaveMemory.Write_StrBytes("88 86 83 00 00 00");
            //mov ebx,[esp+04]
            CaveMemory.Write_StrBytes("8B 5C 24 04");
            ...
            CaveMemory.Write_StrBytes("8A 03");
            //mov [esi+00000082],al
            CaveMemory.Write_StrBytes("88 86 82 00 00 00");
            //Exit:            
            //pop ebx
        ...
        private void SetHack_IsPlaying()
        {
            ...
            //mov ecx,[esp+00000450]
            CaveMemory.Write_StrBytes("8B 8C 24 50 04 00 00");
        ...
        private void SetHack_Recoil()
        {
            ...
            //mov edi,esi
            CaveMemory.Write_StrBytes("8B FE");
            //add edi,_Recoil_CaveAddress
            CaveMemory.Write_StrBytes("81 C7");
            CaveMemory.Write_Bytes(BitConverter.GetBytes(_Recoil_CaveAddress));
            //mov byte ptr[edi], 01
            CaveMemory.Write_StrBytes("C6 07 01");
            //mov edi,[esp+18]
            CaveMemory.Write_StrBytes("8B 7C 24 18");
            //push esi
        ...
        private void SetHack_Ammo()
        {
            ...
            //mov edx,[eax+esi+0000051C]
            CaveMemory.Write_StrBytes("8B 94 30 1C 05 00 00");
            //mov eax,ebx
            CaveMemory.Write_StrBytes("8B C3");
            //shl eax,02
            CaveMemory.Write_StrBytes("C1 E0 02");
            ...
            //mov [eax],edx
            CaveMemory.Write_StrBytes("89 10");
            //pop edx
            CaveMemory.Write_StrBytes("5A");
            //pop eax
            CaveMemory.Write_StrBytes("58");
            //cmp dword ptr [eax+esi+0000051C],00
            CaveMemory.Write_StrBytes("83 BC 30 1C 05 00 00 00");
        ...
        /// We can get the player ID in ESP+24 after pushing EAX
        /// </summary>
        private void SetHack_Damage()
        {
            ...
            CaveMemory.Write_StrBytes("50");
            //mov eax,[esp+24]
            CaveMemory.Write_StrBytes("8B 44 24 24");
            ...
            //pop eax
            CaveMemory.Write_StrBytes("58");
            //add [ebx+eax+00000524],ecx
            CaveMemory.Write_StrBytes("01 8C 03 24 05 00 00");
        ...
        protected override void Apply_NoCrosshairMemoryHack()
        {
            ...
            //fst qword ptr [esp+44]
            CaveMemory.Write_StrBytes("DD 54 24 44");
            //mov [esp+50],C1200000
            CaveMemory.Write_StrBytes("C7 44 24 50 00 00 20 C1");
            //mov [esp+4C],C1200000
            CaveMemory.Write_StrBytes("C7 44 24 4C 00 00 20 C1");
            //fsubr dword ptr [esp+50]
            CaveMemory.Write_StrBytes("D8 6C 24 50");
        ...
        {
            WriteByte((UInt32)_TargetProcess_MemoryBaseAddress + _NoGun_Patch_Offset, 0xEB);
        }
